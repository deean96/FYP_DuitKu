...
class SetWeeklyExpenseLimit extends StatefulWidget {
  SetWeeklyExpenseLimit({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _SetWeeklyExpenseLimitState createState() => _SetWeeklyExpenseLimitState();
}

class _SetWeeklyExpenseLimitState extends State<SetWeeklyExpenseLimit> {
  ...
  Widget build(BuildContext context) {
    ...
    return new Scaffold(
        appBar: new AppBar(
          title: new Text('Set Weekly Expense Limit'),
        ),
        body: new Center(
          child: new Column(
            ...
            children: <Widget>[
              Padding(
                ...
                child: Row(
                  ...
                  children: <Widget>[
                    Text('Set Weekly Your Expense Limit'),
                    SizedBox(width: 5.0),
                  ],
                ),
              ),
              ...
              Padding(
                ...
                child: Row(
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: <Widget>[
                    Text('Current Weekly Expense Limit is RM$expenseLimit'),
                  ],
                ),
              ),
              Padding(
    ...
    await showDialog<double>(
      ...
      builder: (BuildContext context) {
        return new NumberPickerDialog.decimal(
          ...
          title: new Text("Set Your Weekly Expense Limit"),
        );
      },
